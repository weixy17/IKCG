...
from reader.TMI_rebuttle_ACROBAT import LoadACROBAT_image_visualization512
import cv2
...
pipe.validate_for_large_displacement_image_visualization(valid_data,valid_pairs,checkpoint.split('/')[-1].split('.')[0])
sys.exit(0)
