...
# while True:
    ...
    # else:
        ...
        # # train_log = pipe.train_batch_recursive_DLFSFG_multiscale_ite1(args.weight,img1, img2,sift1,sift2,kp1,kp2,kp1_old2,kp2_old2,kp1_512,kp2_512,kp1_512_2,kp2_512_2,kp1_LFS1,kp2_LFS1,kp1_LFS2,kp2_LFS2,kp1_large,kp2_large,kp1_large_1024,kp2_large_1024,kp1_ite1,kp2_ite1 )
        # # train_log = pipe.train_batch_recursive_DLFSFG_multiscale_ite2(args.weight,img1, img2,sift1,sift2,kp1,kp2,kp1_old2,kp2_old2,kp1_512,kp2_512,kp1_512_2,kp2_512_2,kp1_LFS1,kp2_LFS1,kp1_LFS2,kp2_LFS2,kp1_large,kp2_large,kp1_large_1024,kp2_large_1024,kp1_ite1,kp2_ite1,kp1_ite2,kp2_ite2 )
        # train_log = pipe.train_batch_recursive_DLFSFG_multiscale_ite3(args.weight,img1, img2,sift1,sift2,kp1,kp2,kp1_old2,kp2_old2,kp1_512,kp2_512,kp1_512_2,kp2_512_2,kp1_LFS1,kp2_LFS1,kp1_LFS2,kp2_LFS2,kp1_large,kp2_large,kp1_large_1024,kp2_large_1024,kp1_ite1,kp2_ite1,kp1_ite2,kp2_ite2,kp1_ite3,kp2_ite3,kp1_ite4,kp2_ite4)
        # # train_log = pipe.train_batch_densewithsparse_multisift_vgg_vgglarge_maskmorethanvgg_masksamewithvgg(args.weight,img1, img2,sift1,sift2,kp1,kp2,kp1_512,kp2_512,kp1_hand,kp2_hand)
        ...
        # # losses.append(train_log["loss"])
        # # raw_losses.append(train_log["raw loss"])
        # # reg_losses.append(train_log["reg loss"])
        # # kp_losses.append(train_log["dist loss"]+train_log["dist loss2"]+train_log["dist loss3"]+train_log["dist loss4"]+train_log["dist loss5"]+train_log["dist loss6"]+train_log["dist loss7"]+train_log["dist loss8"]+train_log["dist loss9"]+train_log["dist loss10"])
        # # if (steps+1)%300==0:
            # # plt.figure()
            # # plt.plot(losses)
            # # plt.plot(raw_losses)
            # # plt.title('loss+raw_loss')
            # # plt.savefig("/data/wxy/association/Maskflownet_association_1024/training_visualization/"+run_id+'_'+str(steps)+'_all.jpg')
            # # plt.close()
            # # plt.figure()
            # # plt.plot(reg_losses)
            # # plt.plot(kp_losses)
            # # plt.title('reg+kp_loss')
            # # plt.savefig("/data/wxy/association/Maskflownet_association_1024/training_visualization/"+run_id+'_'+str(steps)+'_kp.jpg')
            # # plt.close()
        # # do valiation
        # if steps%1==0: #or steps <= 20:
            # if validationSize > 0:
                ...
                # aa,aa_std,ma,am,am_std,mm,amax,amax_std,mmax = validate_6_evaluation()
                # log.log('steps= {} 6e_aa={},6e_aa_std={},6e_ma={},6e_am={},6e_am_std={},6e_mm={},6e_amax={},6e_amax_std={},6e_mmax={}'.format(steps,aa,aa_std,ma,am,am_std,mm,amax,amax_std,mmax))
                # if aa<minaa:#all_data_least[validate_num]:
                    # minaa=aa
                    # prefix = os.path.join(repoRoot, 'weights', '{}_{}'.format(run_id, steps))
                    # pipe.save(prefix)
                    # print('steps= {} 6e_aa={},6e_aa_std={},6e_ma={},6e_am={},6e_am_std={},6e_mm={},6e_amax={},6e_amax_std={},6e_mmax={}'.format(steps,aa,aa_std,ma,am,am_std,mm,amax,amax_std,mmax))
                ...
                # # if 1:#steps % checkpoint_steps == 0 or steps <= 20:
                    ...
                    # # if aa < minaa: # gl, keep the best model for test dataset.
                        ...
                        # # print('steps= {} 6e_aa={},6e_aa_std={},6e_ma={},6e_am={},6e_am_std={},6e_mm={},6e_amax={},6e_amax_std={},6e_mmax={}'.format(steps,aa,aa_std,ma,am,am_std,mm,amax,amax_std,mmax))
                        # # # print('steps= {} train_aa={},train_aa_std={},train_ma={},train_am={},train_am_std={},train_mm={},train_amax={},train_amax_std={},train_mmax={}'.format(steps,train_aa,train_aa_std,train_ma,train_am,train_am_std,train_mm,train_amax,train_amax_std,train_mmax))
                        # # if not(aa<2.805):##### and ma<2.095 and am<2.225 and mm<1.825
                            # # checkpoints.append(prefix)
                            # # #########remove the older checkpoints
                            # # while len(checkpoints) > 10:
                                # # prefix = checkpoints[0]
