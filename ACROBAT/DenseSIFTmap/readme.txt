...
You can choose to 1. use main_siftflowmap.m to generate single-scale dense SIFT features; 2. use main_multi_siftflowmap.m to generate multiscale dense SIFT features.
