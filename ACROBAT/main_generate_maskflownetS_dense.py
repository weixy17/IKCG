...
from reader.ANHIR import LoadANHIR_generate_maskflownetS_dense
import cv2
...
if dataset_cfg.dataset.value == 'ANHIR':
    ...
    print(subset)
    sys.stdout.flush()
    dataset, groups, groups_train, groups_val = LoadANHIR_generate_maskflownetS_dense(args.prep, subset)
...
log.log('start={}, train={}, val={}, host={}, batch={},generate_maskflownetS_dense,Load Checkpoint {}'.format(steps, trainSize, validationSize, socket.gethostname(), batch_size,checkpoint))
...
print('generate_maskflownetS_dense')
