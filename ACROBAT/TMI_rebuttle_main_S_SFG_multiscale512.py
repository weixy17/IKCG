...
from reader.TMI_rebuttle_ACROBAT import LoadACROBAT_SFG_multiscale512
import cv2
...
if dataset_cfg.dataset.value == 'ACROBAT':
    ...
    print(subset)
    sys.stdout.flush()
    dataset, train_pairs, valid_pairs = LoadACROBAT_SFG_multiscale512()
    ...
    for idx in [13608,11217,5822,15607,8005,9240,2603,15026,44,15823,6220,6449]:
...
large5={:.4f}({:.4f}),mMI={:.4f}({:.4f}),mm75th={:.4f},mm90th={:.4f},""".format(steps,aa,aa_std,ma,m75tha,m90tha,am,am_std,mm,am75th,am75th_std,m75thm75th,am90th,am90th_std,m90thm90th,large1,large1_std,large2,large2_std,\
    ...
    train_log = pipe.train_batch_S_SFG(args.weight,img1, img2,kp1,kp2,'None')
    # update log
...
large5={:.4f}({:.4f}),mMI={:.4f}({:.4f}),mm75th={:.4f},mm90th={:.4f},""".format(steps,aa,aa_std,ma,m75tha,m90tha,am,am_std,mm,am75th,am75th_std,m75thm75th,am90th,am90th_std,m90thm90th,large1,large1_std,large2,large2_std,\
            ...
            # if aa<90 and aa>87.5324 and ma>59.4133 and m75tha>100.6518 and m90tha>181.0176 and am>64.8025 and mm>44.8511 and am75th>101.7702 and m75thm75th>112.7676 and am90th>167.1568\
                # and m90thm90th>365.1966 and large1>152.8848 and large2>178.7675 and large3>200.0862 and large4>236.7204 and large5>432.9995 and mMI<0.6976 and mm75th>65.4791\
                # and mm90th>99.5676:
            # # if aa<95 and aa>84.5252 and ma>59.4126 and m75tha>97.4847 and m90tha>182.0818 and am>60.8624 and mm>41.5020 and am75th>98.7613 and m75thm75th>115.3990\
