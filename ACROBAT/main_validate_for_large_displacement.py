    ...
    if dataset_cfg.dataset.value == "ANHIR":
        ...
        for i in range(0, size, bs):
            ...
            for p in range(0, bs):
                ...
                #pdb.set_trace()
            count=count+1
            mean_rtre,median_rtre= pipe.validate_for_large_displacement(args.weight,img1s, img2s, lmk1s, lmk2s,i+1)
...
log.log('start={}, train={}, val={}, host={}, batch={},sift1,kp_sfg_20,reg_0.05,Load Checkpoint {}'.format(steps, trainSize, validationSize, socket.gethostname(), batch_size,checkpoint))
information = ', '.join(['{}={}'.format(k, repr(args.__dict__[k])) for k in args.__dict__])
log.log(information)
print('sift1,kp_sfg_20,reg_0.05')
