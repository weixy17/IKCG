...
from reader.TMI_rebuttle_ANHIR import LoadANHIR_vgg_vgglarge_multiscale_with_orb,LoadANHIR_LFS_kps_multiscale,LoadANHIR_LFS_multiscale
import cv2
...
if dataset_cfg.dataset.value == 'ANHIR':
    ...
    dataset, groups, groups_train, groups_val = LoadANHIR_LFS_multiscale(args.prep, subset)
    # pdb.set_trace()
...
log.log(information)
print('raw_1,reg_1,kps_vgg16_20,kps_vgg16_large_20,LFS_20')
...
mJacstd={:.8f},mJacfold={:.12f},sJacfold={:.12f}""".format(steps,aa,aa_std,ma,m75tha,am,am_std,mm,am75th,am75th_std,m75thm75th,large1,large1_std,large2,large2_std,\
    ...
    if (steps+1)%10000==0:
        ...
        for i in range (0,len(train_pairs),2):
            ...
            img1, img2,img1_512, img2_512,img1_2048, img2_2048,kp1,kp2,kp1_large,kp2_large,orb1,orb2 = [batch[i] for i in range(12)]
            train_log = pipe.rebuttle_kp_pairs_multiscale(args.weight,img1, img2,img1_512, img2_512,img1_2048, img2_2048,orb1,orb2,i,numname)
        sys.exit(0)
    ...
    img1, img2,kp1,kp2,kp1_2,kp2_2,kp1_3,kp2_3 = [batch[i] for i in range(8)]
    train_log = pipe.train_batch_sparse_vgg_vgglarge_maskmorethanvgg_masksamewithvgg(args.weight,img1, img2,kp1,kp2,kp1_2,kp2_2,kp1_3,kp2_3)
    # update log
