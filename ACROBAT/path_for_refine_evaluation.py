...
def find_checkpoints(run_id,validate_num):
    # pdb.set_trace()
    # weights_dir = os.path.join(repo_root, 'weights_gelin_final')
    weights_dir = os.path.join(repo_root, 'weights',validate_num)
    pattern = r'^{}.*_(\d+)\.params$'.format(run_id)#\d+   946Dec09 724 044Nov29 3206   807Dec22 53 
    # pattern = r'^{}.*_(2100)\.params$'.format(run_id)#\d+   946Dec09 724 044Nov29 3206   807Dec22 53 
