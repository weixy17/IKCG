...
if dataset_cfg.dataset.value == 'ACROBAT':
    ...
    print(subset)
    sys.stdout.flush()
    dataset, train_pairs, valid_pairs = LoadACROBAT_DFS_SFG_singlescale512_layer2_3()
    # dataset, train_pairs, valid_pairs = LoadACROBAT_DFS_SFG_singlescale512()
...
# create log file
if not args.valid:
    string='raw_1,reg_1,vgg16single_layer2_3_20,LFS_0'
...
large5={:.4f}({:.4f}),mMI={:.4f}({:.4f}),mm75th={:.4f},mm90th={:.4f},""".format(steps,aa,aa_std,ma,m75tha,m90tha,am,am_std,mm,am75th,am75th_std,m75thm75th,am90th,am90th_std,m90thm90th,large1,large1_std,large2,large2_std,\
            ...
            # pdb.set_trace()
            # if aa<95 and aa>=90.6717 and m75tha>=107.5343 and am75th>=106.7557 and m75thm75th>=122.2886 and mMI<=0.6917:
            if aa<100 and aa>=87.5324 and m75tha>=100.6518 and am75th>=101.7702 and m75thm75th>=112.7676 and mMI<=0.6976:
