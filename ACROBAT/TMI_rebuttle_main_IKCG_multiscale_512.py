...
if dataset_cfg.dataset.value == 'ACROBAT':
    ...
    print(subset)
    sys.stdout.flush()
    dataset, train_pairs, valid_pairs = LoadACROBAT_IKCG_1ite_multiscale512()
    # dataset, train_pairs, valid_pairs = LoadACROBAT_KCG_kps_ite1_multiscale512()
    # dataset, train_pairs, valid_pairs = LoadACROBAT_KCG_kps_ite2_multiscale512()########generate new matched key points iteratively
...
while True:
    ...
    train_log = pipe.train_batch_IKCG(args.weight,img1, img2,sift1,sift2,kp1,kp2,kp1_2,kp2_2,kp1_3,kp2_3)
    # update log
