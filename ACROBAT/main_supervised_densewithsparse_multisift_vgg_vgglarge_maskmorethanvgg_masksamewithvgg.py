...
from reader.ANHIR import LoadANHIR_supervised_vgg_vgglarge_maskmorethanvgg_masksamewithvgg
import cv2
...
if dataset_cfg.dataset.value == 'ANHIR':
    ...
    print(subset)
    sys.stdout.flush()
    dataset, groups, groups_train, groups_val = LoadANHIR_supervised_vgg_vgglarge_maskmorethanvgg_masksamewithvgg(args.prep, subset)
...
log.log('start={}, train={}, val={}, host={}, batch={},raw_multisift_1,reg_0.05,maskflownet_S-more_than_vgg_dist_5,maskflownet_S_more_than_vgg_dist_10,vgg_dist_20,vgg_large_dist_20,gt_20,Load Checkpoint {}'.format(steps, trainSize, validationSize, socket.gethostname(), batch_size,checkpoint))
information = ', '.join(['{}={}'.format(k, repr(args.__dict__[k])) for k in args.__dict__])
log.log(information)
print('raw_multisift_1,reg_0.05,maskflownet_S-more_than_vgg_dist_5,maskflownet_S_more_than_vgg_dist_10,vgg_dist_20,vgg_large_dist_20,gt_20')
...
while True:
    ...
    img1, img2,kp1,kp2,kp1_mask_same_with_vgg,kp2_mask_same_with_vgg,kp1_mask_more_than_vgg,kp2_mask_more_than_vgg,kp1_gt,kp2_gt = [batch[i] for i in range(10)]
    ...
    train_log = pipe.train_batch_supervised_densewithsparse_multisift_vgg_vgglarge_maskmorethanvgg_masksamewithvgg(args.weight,img1, img2,sift1,sift2,kp1,kp2,kp1_mask_same_with_vgg,kp2_mask_same_with_vgg,kp1_mask_more_than_vgg,kp2_mask_more_than_vgg,kp1_gt,kp2_gt)
    # update log
