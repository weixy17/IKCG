...
if dataset_cfg.dataset.value == 'ACROBAT':
    ...
    print(subset)
    sys.stdout.flush()
    dataset, train_pairs, valid_pairs = LoadACROBAT_for_submit()
...
while True:
    ...
    aa,aa_std,ma,mm90th,am90th,am90th_std= pipe.validate_ACROBAT_for_submit(valid_data,valid_pairs,checkpoint.split('/')[-1].split('.')[0])
    print("""steps= {} aa={:.0f}({:.0f}),ma={:.0f}, mm90th={:.0f}, am90th={:.0f}({:.0f}),""".format(steps,aa,aa_std,ma,mm90th,am90th,am90th_std))
    sys.exit(0)