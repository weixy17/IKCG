...
from reader.ANHIR import LoadANHIR_DLFS_SFG_multiscale
import cv2
...
log.log('start={}, train={}, val={}, host={}, batch={},raw_1.3,reg_1,lmk_30,lmk_old2_15,lmk_old5_15,lmk_large_30,lmk_LFS1_15,lmk_LFS2_15,Load Checkpoint {}'.format(steps, trainSize, validationSize, socket.gethostname(), batch_size,checkpoint))
...
log.log(information)
print('raw_1,reg_1,lmk_30,lmk_old2_15,lmk_old5_15,lmk_large_30,lmk_LFS1_15,lmk_LFS2_15')
# print('raw_1.3,reg_0.05,maskflownet_S-more_than_vgg_dist_0,maskflownet_S_more_than_vgg_dist_0,vgg_dist_20,vgg_large_dist_20,maskflownet_corrected_10')
...
while True:
    ...
    img1, img2,kp1,kp2,kp1_old2,kp2_old2,kp1_old5,kp2_old5,kp1_large,kp2_large,kp1_LFS1,kp2_LFS1,kp1_LFS2,kp2_LFS2 = [batch[i] for i in range(14)]
    train_log = pipe.train_batch_DLFS_SFG_multiscale(args.weight,img1, img2,kp1,kp2,kp1_old2,kp2_old2,kp1_old5,kp2_old5,kp1_large,kp2_large,kp1_LFS1,kp2_LFS1,kp1_LFS2,kp2_LFS2)
    # update log
    ...
    if steps % validation_steps == 0 or steps <= 100: #or steps <= 20:
        if validationSize > 0:
            ...
            if steps % checkpoint_steps == 0 or steps <= 20:
                if aa<2.755 and ma<2.095:#(aa<2.755 and ma<2.135 and am<2.235 and mm<1.825):
                ...
                # if aa < minaa: # gl, keep the best model for test dataset.
                    ...
                    # pipe.save(prefix)
                    # print('steps= {} aa={},aa_std={},ma={} am={},am_std={},mm={}'.format(steps,aa,aa_std,ma,am,am_std,mm))
                    # if not(aa<2.755 and ma<2.135 and am<2.235 and mm<1.825):
