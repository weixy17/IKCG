...
if dataset_cfg.dataset.value == 'ACROBAT':
    ...
    print(subset)
    sys.stdout.flush()
    dataset, train_pairs, valid_pairs = LoadACROBAT_F_KCG_multiscale512()
...
# create log file
if not args.valid:
    string='raw_1,reg_1,vgg16_0,LFS_0'############regularization parameters
...
while True:
    ...
    train_log = pipe.train_batch_F_KCG(args.weight,img1, img2,kp1,kp2)
    # update log
