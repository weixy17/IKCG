...
if not args.valid and not args.gkps:
    string='rawSIFT_1,reg_1,vgg16_30,LFS_30,ite1_30'
...
# siftdir="/ssd2/wxy/IPCG_Acrobat/data/data_for_deformable_network/SIFT_features/train_4096_to512_masked/"
while True:
    if args.valid:
...
large5={:.4f}({:.4f}),mMI={:.4f}({:.4f}),mm75th={:.4f},mm90th={:.4f},""".format(steps,aa,aa_std,ma,m75tha,m90tha,am,am_std,mm,am75th,am75th_std,m75thm75th,am90th,am90th_std,m90thm90th,large1,large1_std,large2,large2_std,\
    ...
    train_log = pipe.train_batch_densewithsparse_multisift_vgg_vgglarge_maskmorethanvgg_masksamewithvgg(args.weight,img1, img2,sift1,sift2,kp1,kp2,kp1_2,kp2_2,kp1_3,kp2_3)
    # update log
