...
from reader.ANHIR import LoadANHIR_vgg_vgglarge_maskmorethanvgg_masksamewithvgg_with_corrected_LFS
import cv2
...
if dataset_cfg.dataset.value == 'ANHIR':
    ...
    print(subset)
    sys.stdout.flush()
    dataset, groups, groups_train, groups_val = LoadANHIR_vgg_vgglarge_maskmorethanvgg_masksamewithvgg_with_corrected_LFS(args.prep, subset)
    # pdb.set_trace()
...
log.log('start={}, train={}, val={}, host={}, batch={},raw_1,reg_0.05,maskflownet_S-more_than_vgg_dist_5,maskflownet_S_more_than_vgg_dist_10,vgg_dist_15,vgg_large_dist_15,maskflownet_corrected_10,Load Checkpoint {}'.format(steps, trainSize, validationSize, socket.gethostname(), batch_size,checkpoint))
# log.log('start={}, train={}, val={}, host={}, batch={},raw_1,reg_0.05,maskflownet_S-more_than_vgg_dist_0,maskflownet_S_more_than_vgg_dist_0,vgg_dist_20,vgg_large_dist_20,maskflownet_corrected_10,Load Checkpoint {}'.format(steps, trainSize, validationSize, socket.gethostname(), batch_size,checkpoint))
information = ', '.join(['{}={}'.format(k, repr(args.__dict__[k])) for k in args.__dict__])
log.log(information)
print('raw_1,reg_0.05,maskflownet_S-more_than_vgg_dist_5,maskflownet_S_more_than_vgg_dist_10,vgg_dist_15,vgg_large_dist_15,maskflownet_corrected_10')
# print('raw_1,reg_0.05,maskflownet_S-more_than_vgg_dist_0,maskflownet_S_more_than_vgg_dist_0,vgg_dist_20,vgg_large_dist_20,maskflownet_corrected_10')
...
while True:
    ...
    img1, img2,kp1,kp2,kp1_mask_same_with_vgg,kp2_mask_same_with_vgg,kp1_mask_more_than_vgg,kp2_mask_more_than_vgg,kp1_corrected,kp2_corrected = [batch[i] for i in range(10)]
    train_log = pipe.train_batch_sparse_vgg_vgglarge_maskmorethanvgg_masksamewithvgg_with_corrected_LFS(args.weight,img1, img2,kp1,kp2,kp1_mask_same_with_vgg,kp2_mask_same_with_vgg,kp1_mask_more_than_vgg,kp2_mask_more_than_vgg,kp1_corrected,kp2_corrected)
    # update log
        ...
        if validationSize > 0:
            ...
            if steps % checkpoint_steps == 0 or steps <= 20:
                if aa < minaa: # gl, keep the best model for test dataset.
                    ...
                    if not(aa<3.055 and ma<2.425 and am<2.455 and mm<2.045):
