...
parser.add_argument('--gkps', action='store_true', help='Do generate kps')
...
if dataset_cfg.dataset.value == 'ACROBAT':
    ...
    print(subset)
    sys.stdout.flush()
    dataset, train_pairs, valid_pairs = LoadACROBAT_LFS_SFG_kps_multiscale512()
...
large5={:.4f}({:.4f}),mMI={:.4f}({:.4f}),mm75th={:.4f},mm90th={:.4f},""".format(steps,aa,aa_std,ma,m75tha,m90tha,am,am_std,mm,am75th,am75th_std,m75thm75th,am90th,am90th_std,m90thm90th,large1,large1_std,large2,large2_std,\
    ...
    if args.gkps:
        ...
        count=count+1
        for i in range (265,train_pairs_nums_unique.shape[0]):
            print(i)
