...
from reader.ANHIR import LoadANHIR_vgg_vgglarge_multiscale_new
import cv2
...
log.log('start={}, train={}, val={}, host={}, batch={},raw_1,reg_1,vgg_40,vgg_old2_20,vgg_old5_20,vgg_large_40,Load Checkpoint {}'.format(steps, trainSize, validationSize, socket.gethostname(), batch_size,checkpoint))
information = ', '.join(['{}={}'.format(k, repr(args.__dict__[k])) for k in args.__dict__])
log.log(information)
# print('raw_1,reg_0.05,vgg_0.2_0.5_same_20,vgg_0.2_0.5_diff_10,vgg_large_20')
# print('raw_1,reg_1,vgg_20,vgg_old2_0,vgg_old5_0,vgg_large_15')
print('raw_1,reg_1,vgg_40,vgg_old2_20,vgg_old5_20,vgg_large_40')
        ...
        if validationSize > 0:
            ...
            if steps % checkpoint_steps == 0 or steps <= 20:
                if aa < minaa: # gl, keep the best model for test dataset.
                    ...
                    if not(aa<2.80):#(aa<3.045 and ma<2.425 and am<2.445 and mm<1.975):
